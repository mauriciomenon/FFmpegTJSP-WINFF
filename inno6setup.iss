...
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\charset_normalizer\*"; DestDir: "{app}\charset_normalizer"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\cryptography\*"; DestDir: "{app}\cryptography"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\cryptography-41.0.3.dist-info\*"; DestDir: "{app}\cryptography-41.0.3.dist-info"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\tcl\*"; DestDir: "{app}\tcl"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\tcl8\*"; DestDir: "{app}\tcl8"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\tk\*"; DestDir: "{app}\tk"; Flags: ignoreversion recursesubdirs createallsubdirs

; Inclua todos os outros arquivos na raiz
Source: "C:\Users\menon\git\FFmpegTJSP-WINFF\dist\FFmpeg - TJSP (inclui ffmpeg)\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
